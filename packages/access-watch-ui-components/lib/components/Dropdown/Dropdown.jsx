...
export default class Dropdown extends React.Component {
  ...
  getOpenState = _ => ('open' in this.props ? this.props.open : this.state.open);
  ...
  createChildItem = (c, i) => {
    ...
    if (closeDropdownAction) {
      props[closeDropdownAction] = (...args) => {
        this.onClickOutside();
        return c.props[closeDropdownAction] && c.props[closeDropdownAction](...args);
      };
    }
  ...
  render() {
    ...
    return (
      <div ref={ref => { this.dropdownNode = ref; }} className={cx('dropdown', className, {'dropdown--open': open})}>
        {select &&
          <button
          ...
          >
            ...
            {activeKey && Object.keys(values).length ? values[activeKey].text : activeKey}
            <span
